...
- Name: Additional E2E tests >> should open main page and check title
- Location: /Users/jibbr/Desktop/hellogpt/tests/e2e.additional.spec.ts:4:3
...
Call log:
  - navigating to "http://localhost:3000/", waiting until "load"
    ...
    at /Users/jibbr/Desktop/hellogpt/tests/e2e.additional.spec.ts:5:16
```
